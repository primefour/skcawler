...
func IsFileExists(path string) bool {
	...
	panic("IsFileExists not reached")
}

//scan directory with file suffixes
...
//scan directory with directory suffixes
...
//get file list with relative file path
